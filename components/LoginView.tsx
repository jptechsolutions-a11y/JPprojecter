        ...
        <div className="w-full md:w-1/2 bg-white p-12 flex flex-col justify-center items-center relative transition-all">
            <div className="mb-8 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-500">
                    {mode === 'login' ? 'Gerencie projetos com inteligência' : mode === 'register' ? 'Junte-se à equipe JP Projects' : 'Enviaremos um link de acesso'}
                </p>
            </div>

            <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-4">
                {errorMsg && (
                    <div className="p-3 bg-red-50 border border-red-200 text-red-600 text-sm rounded-lg text-center animate-fade-in font-medium">
                        {errorMsg}
                    </div>
                )}
